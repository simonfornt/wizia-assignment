    ...
    <section className="relative h-auto md:min-h-[600px] flex items-center justify-center text-white bg-[#00222d]">
      ...
      <div className="z-10  px-4 py-8 md:py-12">
        <div className="max-w-[500px] md:max-w-none md:ml-[30%] lg:ml-[400px]">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-left">
            Train your aiDR on your...
          </h1>
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 text-left text-cyan-400 italic">
            preferred email style
          </h2>
          
          {/* Responsive paragraph text */}
          <p className="text-base md:text-xl text-gray-200 mb-6 md:mb-8 text-left">
