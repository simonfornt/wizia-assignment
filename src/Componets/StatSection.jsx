      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center md:text-left py-10 px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 font-monster sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-white text-base font-[500] font-monster md:text-xl">
          ...
          <div className="text-center">
            ...
            <p className="text-white text-base font-[500] md:text-xl">
          ...
          <div className="text-center">
            ...
            <p className="text-white font-[500] text-base md:text-xl">
